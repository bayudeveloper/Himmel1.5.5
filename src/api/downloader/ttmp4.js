...
/* ENDPOINT VIDEO */
app.get("/tiktok/video", async (req, res) => {
  ...
  try {
    ...
    const filename = `${data.author}_${Date.now()}.mp4`;
    ...
    await downloadFile(data.video, filepath);
...
app.listen(PORT, () => {
  console.log(`🚀 TikTok VIDEO API jalan di http://localhost:${PORT}`);
});